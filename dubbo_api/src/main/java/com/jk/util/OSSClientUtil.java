...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAIwzYsY4r0pBPd";
    private String accessKeySecret = "lWsg0CgR3VzXBDWRLLw9cqRGwgTEun";
    // 空间
    private String bucketName = "whkokon";
    // 文件存储目录
    private String filedir = "whkokon/";
